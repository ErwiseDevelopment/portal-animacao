                ...
                <div class="col-12">
                    ...
                    <div class="row justify-content-end">
                        ...
                        <div class="col-lg-2 d-flex justify-content-center my-4 px-0">
                            ...
                            href="<?php echo $link_pattern . 'noticias/?cat=63'?>" 
                            data-aos="zoom-in">
                                + Notícias
                            </a>
                        </div>
...
<!-- founder -->
<?php echo get_template_part( 'template-parts/content', 'founder' ) ?>
<!-- end founder -->

<!-- materials -->
<?php echo get_template_part( 'template-parts/content', 'materials' ) ?>
<!-- end materials -->
<!-- digital -->
