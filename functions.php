...
function mantenedora_create_page() {
	...
	if( function_exists('acf_add_options_page') ) {	
        ...
        acf_add_options_page( 
            array( 
                'page_title' => 'Casas de Formação', 
                'menu_title' => 'Casas de Formação', 
                'menu_slug'  => 'casas_de_formacao', 
                'capability' => 'edit_posts', 
                'position'   => '23,4', 
                'redirect'   => false, 
        ...
        // acf_add_options_page( 
        //     array( 
        //         'page_title' => 'Santidade Salesiana', 
        //         'menu_title' => 'Santidade Salesiana', 
        //         'menu_slug'  => 'santidade_salesiana', 
        //         'capability' => 'edit_posts', 
        //         'position'   => '23,4', 
        //         'redirect'   => false, 
        //         'icon_url'   => 'dashicons-admin-home',
...
function mantenedora_create_post_type() { 
    ...
    register_post_type( 'santidade_salesiana', array(
		'labels' 		=> array( 'name' => 'Santidade Salesiana', 'singular_name' => 'Santidade Salesiana', 'all_items' => 'Todas as pessoas' ),
		'public' 		=> true,
		'has_archive'	=> true,
		'menu_icon'		=> 'dashicons-format-gallery',
...
function single_temas_scripts()
{
    ...
    wp_enqueue_script('single-temas-rename-swiper-button', get_template_directory_uri() . '/../wp-bootstrap-starter-child/assets/js/rename-swiper-button.js', array(), '1.0.2', true);
    wp_enqueue_script('single-temas-modal-about', get_template_directory_uri() . '/../wp-bootstrap-starter-child/assets/js/modal-about.js', array(), '1.0.2', true);
    wp_enqueue_script('single-temas-filter-state', get_template_directory_uri() . '/../wp-bootstrap-starter-child/assets/js/filter-state.js', array(), '1.0.2', true);
